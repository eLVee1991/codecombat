module.exports = nativeDescription: "Nederlands (Nederland)", englishDescription: "Dutch (Netherlands)", translation:
  ...
  play:
    ...
    skills_granted: "Vaardigheden verkregen" # Property documentation details
    ...
    campaign_old_multiplayer: "(Afgeschaft) Oude Multiplayer Arena's"
    campaign_old_multiplayer_description: "Relikwie uit een meer beschaafde tijd. Er draaien geen simulaties voor deze held-loze multiplayer arena's."
  ...
  play_level:
    ...
    infinite_loop_description: "De basiscode die gebruikt is om de wereld te bouwen draait nog steeds. Het is waarschijnlijk erg langzaam of staat in een oneindige loop. Of er staat een fout in. Je kunt hem opnieuw aanzetten of de code herstellen naar de basis. Als dat niet helpt, laat het ons alsjeblieft weten."
    check_dev_console: "Je kunt ook het ontwikkelaars console openen om te bekijken wat er verkeerd gaat."
    ...
    tip_superpower: "Coderen komt het dichtst bij het bezitten van een superkracht."
    tip_control_destiny: "In echte open source, heb je het recht om je eigen lot te bepalen. - Linus Torvalds"
    ...
    tip_optimization_operator: "Iedere taal heeft operator voor optimalisatie. Bij de meeste talen is die operator '//'"
    ...
    tip_javascript_java: "Java is van JavaScript wat een auto van een stuk tapijt is. - Chris Heilmann"
    ...
    tip_recurse: "Parafraseren is menselijk, iets overnemen bovenmenselijk. - L. Peter Deutsch"
  ...
  game_menu:
    ...
    guide_caption: "Documenten and tips"
  ...
  buy_gems:
    ...
    recovered: "Vorige aankoop met edelstenen hersteld. Ververs de pagina."
#    price: "x3500 / mo"

  subscribe:
    comparison_blurb: "Verbeter je vaardigheden met een abonnement bij CodeCombat!"
    ...
    feature4: "<strong>3500 bonus edelstenen</strong> iedere maand!"
    feature5: "Video cursussen"
    feature6: "Premium email ondersteuning"
    feature7: "Privé <strong>Clans</strong>"
    free: "Gratis"
    month: "maand"
    ...
    parents_blurb2: "Voor $9.99 USD/pm, kan uw kind wekelijks nieuwe uitdagingen krijgen en persoonlijke email ondersteuning van professionele programmeurs."
    ...
    sale_blurb2: "van een normaal abonnement. Prijs $120 voor een heel jaar!"
    sale_button: "Koopje!"
    ...
    sale_feature4: "<strong>42,000 bonus edelstenen</strong> onmiddelijk toegekend!"
    sale_continue: "Klaar voor het avontuur?"
    sale_limited_time: "Tijdelijke aanbieding"
    sale_new_heroes: "Nieuwe helden!"
    sale_title: "Back to School uitverkoop"
    ...
    unlock_help_videos: "Meld je aan om alle videohandleidingen te zien."
    personal_sub: "Persoonlijk abonnement" # Accounts Subscription View below
    loading_info: "Laden informatie abonnement..."
    managed_by: "Gesorteerd bij"
    will_be_cancelled: "Zal gestopt worden op"
    currently_free: "Je hebt momenteel een gratis account"
    currently_free_until: "Je hebt momenteel een abonnement tot"
    was_free_until: "Je hebt een gratis abonnement gehad tot"
    managed_subs: "Beheerde abonnementen"
    managed_subs_desc: "Maak abonnementen aan voor andere spelers (studenten, kinderen, etc.)"
    managed_subs_desc_2: "Ontvangers moeten een account hebben bij CodeCombat met het emaiadres dat je opgeeft."
  ...
  choose_hero:
    ...
    lua_blurb: "Game script taal."
    io_blurb: "Simepel maar duister"
    status: "Status"
    hero_type: "Soort"
    weapons: "Wapens"
    ...
    blocks: "Blokkeren" # As in "this shield blocks this much damage"
    backstab: "Backstab" # As in "this dagger does this much backstab damage"
    skills: "Vaardigheden"
    attack_1: "Uitdelen"
    attack_2: "Niet op de lijst"
    attack_3: "Schade aan het wapen."
    health_1: "Verbeteringen"
    health_2: "Niet op de lijst"
    health_3: "Gezondheid harnas"
    speed_1: "Beweegt met"
...
#    returns: "Returns"
  ...
  options:
    ...
    editor_config_level_language_description: "Bepaal de programmeertaal voor dit level."
  ...
  about:
    ...
    matt_blurb: "Fietser"
    cat_title: "Hoofd aanbachtsman"
    cat_blurb: "Luchtmeesters"
    josh_title: "Game ontwerper"
  ...
  teachers:
    ...
    cost_china: "CodeCombat is in China gratis voor de eerte vijf levels, daarna kost het $9,99/pm om toegang te krijgen tot onze overige 180+ levels op onze exlusieve Chinese servers."
    ...
    teacher_subs_1: "Vul alsjeblieft onze"
    teacher_subs_2: "Leerkrachten enquête"
    teacher_subs_3: "om je abonnement op te zetten."
    sub_includes_title: "Wat zit er in het abonnement?"
    sub_includes_1: "Naast de 110+ basis levels, kunnen studenten die een maandelijks abonnement hebben toegang krijgen tot deze extra toevoegingen:"
    sub_includes_2: "70+ oefen levels"
    sub_includes_3: "Videohandleidingen"
    sub_includes_4: "Premium email ondersteuning"
    sub_includes_5: "10 nieuwe helden met een unieke vaardigheid om onder de knie te krijgen"
    sub_includes_6: "3500 bonus edelstenen iedere maand"
    sub_includes_7: "Privé Clans"
    ...
    private_clans_1: "Privé Clans hebben meer privacy en gedetailleerdere voortgang voor elke leerlingen."
    private_clans_2: "Om een privé clan te maken, bekijk vink 'maak een privé clan' aan wanneer je een"
    private_clans_3: "."
    ...
    material_china: "Momenteel ongeveer 40 uur speeltijd verdeelt over 180+ levels voor abonnementhouders"
    ...
    how_much_3: "kost $9.99, en kan ten alle tijden opgezegd worden."
    how_much_4: "Daarnaast bieden we groepskortingen voor grotere groepen:"
    how_much_5: "We accepteren korting voor eenmalige aankopen en jaarlijkse abonnementen voor groepen, zoals een klas of een school. Neem contact op"
  ...
  versions:
    ...
    submitting_patch: "Patch toevoegen..."
    cla_prefix: "Om bewerkingen op te slaan, moet je eerst akkoord gaan met onze"
    cla_url: "CLA"
    cla_suffix: "."
    cla_agree: "IK GA AKKOORD"
    owner_approve: "Een eigenaar moet het je aanpassingen goed keuren voordat ze zichtbaar worden."
  ...
  keyboard_shortcuts:
    ...
    scrub_playback: "Spoel voor- en achteruit in de tijd."
    single_scrub_playback: "Spoel voor- en achteruit in de tijd per frame"
    scrub_execution: "Spoel door een huidige uitvoering van een vloek"
    toggle_debug: "Toggle debug schermToggle debug display."
    toggle_grid: "Toggle grid overlay."
    toggle_pathfinding: "Toggle pathfinding overlay."
    beautify: "Versier je code door je format te standaardiseren."
    maximize_editor: "Maximaliseer/minimaliseer de code editor."
  ...
  community:
    ...
    thang_editor_prefix: "We noemen de units binnen een game 'thangs'. Gebruik de."
    thang_editor_suffix: "Gebruik de source  om de artwork van CodeCombat te bewerken, door units projectielen te laten gooien, de richting van de animatie, verander de hit points van een unit of je eigen Vector geesten te uploaden."
  ...
  clans:
    ...
    make_private: "Maak clan privé"
    subs_only: "Alleen voor abonnees subscribers only"
    ...
    latest_achievement: "Laatste prestaties"
    playtime: "Speeltijd"
    last_played: "Laatst gespeeld"
    leagues_explanation: "Speel tegen andere clan member in een divisie in deze multiplayer arena's."
  ...
  courses:
    ...
    receive_code: "Hierna zal je een unlock code ontvangen om te verspreiden over je studenten. Die kunnen ze gebruiken om zich in te schrijven voor je klas."
    ...
    answer2: "De singleplayer game heeft items, edelstenen, held keuzemenu, levels verhogen, een in-app aankopen. Vakken hebben klassenmanagement mogelijkheden en die wordt de score van uw studenten continu bijgewerkt."
  ...
  editor:
    ...
    achievement_query_misc: "Belangrijke prestaties van miscellanea"
    achievement_query_goals: "Belangrijke prestaties van level goals"
    level_completion: "Level Voltooiing"
    pop_i18n: "Populate I18N"
    tasks: "Taken"
    clear_storage: "Leeg je plaatselijke instellingen"
    add_system_title: "Voegen systemen toe aan level"
