...
#    campaign_old_multiplayer: "(Verouderd) Oude Multiplayer Arena's"
#    campaign_old_multiplayer_description: "Relekwie is een meer beschaafde tijd. Er worden geen simulaties gedraait voor deze oude, held-loze multiplayer arena's."
...
#    victory_viking_code_school: "Allemachtig, dat was een moeilijk level die je hebt verslagen! Als je nog geen softwareontwikkelaar bent, dan moet je dat zeker worden. Je hebt net een voorrangsaanmelding gekregen voor de Vinking Code School, waar je je vaardigheden naar het volgende niveau kunt tillen en een professionele web ontwikkelaar kunt worden in 14 weken."
    victory_become_a_viking: "Word een Viking"
#    victory_bloc: "Goed gedaan! Je vaardigheden verbeteren en dit valt op. Als je er ooit aan gedacht hebt om een softwareontwikkelaar te worden, dan is dit je geluksdag! Bloc is een online trainingscamp die je koppelt aan een expertmentor die je gaat helpen om jou om te toveren in een professionele ontwikkelaar! Door het level A Mayham of Munchkins te verslaan, heb je nu recht op een korting bon ter waarde van $500 met de code: CCRULES"
...
#    tome_cast_button_running: "In uitvoering"
...
#    infinite_loop_description: "De basiscode die de wereld heeft gebouwd is nooit gestopt met draaien. Het is waarschijnlijk erg langzaam of het staat in een oneindige herhaling (loop). Of er is een bug. Je kunt of de code opnieuw draaien of hem herstellen naar de standaarduitvoering. Als dat niet help, laat het ons alsjeblieft weten."
#    check_dev_console: "Je kunt ook de ontwikkelaars console openen om te kijken wat er verkeerd gaat."
...
#    tip_extrapolation: "Er zijn maar twee soorten mensen: degene die iets kunnen herleiden uit incomplete data…"
#    tip_superpower: "Kunnen coderen komt het dichtst in de buurt van super krachten."
#    tip_control_destiny: "Met echte open-source, heb je het recht om je eigen lot te bepalen. – Linus Torvalds"
#    tip_no_code: "Geen code is sneller dan geen code"
    tip_code_never_lies: "Code liegt niet, commentaar soms wel. — Ron Jeffries"
#    tip_reusable_software: "Voordat software herbruikt kan worden moet het eerst werken"
#    tip_optimization_operator: "Iedere programmeertaal heeft een optimale operator. Bij de meeste talen is die operator '//'"
#    tip_lines_of_code: "De voortgang van programma’s meten door middel van regels code is net zoals een vliegveld meten met gewicht. – Bill Gates"
#    tip_source_code: "Ik wil de wereld veranderen maar ze wilde me de broncode niet geven."
...
#    tip_adding_evil: "We voegen een beetje meer kwaad toe."
#    tip_hate_computers: "Het ding met mensen die zeggen dat ze computers haten is dat ze eigenlijk een hekel hebben aan gemakzuchtige programmeurs. – Larry Niven"
    tip_open_source_contribute: "Je kunt helpen CodeCombat te verbeteren!"
#    tip_recurse: "Iets parafraseren is menselijk, iets To iterate is human, iets overnemen bovenmenselijk. - Peter Deutsch"
#    tip_free_your_mind: "Je moet alles laten gaan, Neo. Angst, twijfel en ongeloof. Maak je geest vrij.- Morpheus"
    tip_strong_opponents: "Zelf de sterkste vijand heeft een zwakheid. - Itachi Uchiha"
#    tip_paper_and_pen: "Voordat je start met coderen, kun je altijd een plan opstellen met pen en papier."
...
#    top_players: "Top spelers"
    ...
    all: "Altijd"
    time: "tijd"
#    damage_taken: "Opgelopen schade"
#    damage_dealt: "Schade toegediend"
...
#    recovered: "De afgelopen aankoop met edelstenen is hersteld. Ververs de pagina."
#    price: "x3500 / mo"

  subscribe:
#    comparison_blurb: "Verbeter je vaardigheden met een CodeCombat abonnement!"
...
#    feature5: "Video handleiding"
#    feature6: "Premium email hulp"
...
#    parents_blurb2: "Voor $9,99 USD/pm kan je kind wekelijks nieuwe uitdaging krijgen en persoonlijke hulp via email door professionele programmeurs. "
...
#    sale_blurb2: "Van het gewone abonnement een prijs van $129 voor een heel jaar!"
    sale_button: "Koopje!"
...
#    sale_feature4: "<strong>42,000 bonus edelstenen</strong> gelijk ontvangen!"
    sale_continue: "Klaar voor het avontuur?"
#    sale_limited_time: "Aanbieding voor beperkte tijd!"
...
#    unlock_help_videos: "Met je aan om alle videohandeleidingen te unlocken."
#    personal_sub: "Persoonlijk abonnement" # Accounts abonnement zie hier beneden"
#    loading_info: "Laden informatie abonnement..."
#    managed_by: "Beheerd door"
#    will_be_cancelled: "Zal stopgezet worden op"
    currently_free: "Je hebt momenteel een gratis account"
#    currently_free_until: "Je abonnement loopt momenteel tot"
#    was_free_until: "Je hebt een gratis abonnement tot"
#    managed_subs: "Beheerde abonnementen"
#    managed_subs_desc: "Voeg abonnementen toe voor andere speleres (studenten, kinderen, etc.)"
#    managed_subs_desc_2: "Ontvangers moeten een CodeCombat account hebben die gelinkt is aan het emailadres dat je opgegeven hebt."
    group_discounts: "Groepskorting"
    group_discounts_1: "We bieden groepskortingen aan voor grote groepen."
#    group_discounts_1st: "1ste abonnement"
#    group_discounts_full: "Volle prijs"
#    group_discounts_2nd: "Abonnement 2-11"
#    group_discounts_20: "20% korting"
#    group_discounts_12th: "Abonnement 12+"
#    group_discounts_40: "40% korting"
#    subscribing: "Abonneren..."
#    recipient_emails_placeholder: "Vul je emailadres in te abonneren, één emailadres per regel."
#    subscribe_users: "Abonneren gebruikers"
#    users_subscribed: "Gebruikers geabonneerd"
#    no_users_subscribed: "Geen gebruikers geabonneerd, controleer de emailadressen."
#    current_recipients: "Hudige ontvanger"
#    unsubscribing: "Afmelden..."
#    subscribe_prepaid: "Klink om je aan te abonneren met een prepaid code"
#    using_prepaid: "Een prepaid code gebruiken voor een maandelijks abonnement"
...
#    lua_blurb: "Scripttaal van de game."
...
#    attack: "Damage" # Kan je ook vertalen als "Attack"
    health: "Gezondheid"
    speed: "Snelheid"
    regeneration: "Herstel"
#    range: "Range" # als in "aanvallen of zichtbaarheid"
#    blocks: "Blocks" # als in "dit schild blokkeert teveel schade"
#    backstab: "Backstab" # Als in "dit mes doet zoveel schade aan de rug"
    skills: "Vaardigheden"
#    attack_1: "Aanbiedingen"
#    attack_2: "niet op de lijst"
#    attack_3: "schade door wapers."
#    health_1: "Verbeteringen"
#    health_2: "niet op de lijst"
#    health_3: "gezondheid pantser."
#    speed_1: "Moves at"
    speed_2: "meter per seconde."
#    available_for_purchase: "Beschikbaar voor aankoop" # Verschijnt wanneer je een held niet gekocht, maar unlocked hebt.
#    level_to_unlock: "Level om te unlocken:" # Label waar je kunt zien welke level je moet verslaan om een specifieke held te unlocken (Klik op het slotje van de held om hem te bekijken)
    restricted_to_certain_heroes: "Only certain heroes can play this level."

  skill_docs:
#    writable: "Schrijfbaar" # Beweeg over "attack" in je Skills terwijl je een level speelt om er het meest van te zien.
#    read_only: "Aleen leesbaar"
    action: "Actie"
    spell: "toverspreuk"
    action_name: "naam"
